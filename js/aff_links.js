...
// Holger: Hier wird jedes Netzwerk entfernt, das nicht zum Link passt      
	   ...
	   if ( netzwerkliste.indexOf('awin') == -1) {
	 		$('select[name="nw_aktiv"] option[value="awin"]', editRow).remove();
	   	}
	   ...
	   if ( netzwerkliste.indexOf('eBayPartnerNet') == -1) {
	 		$('select[name="nw_aktiv"] option[value="eBayPartnerNet"]', editRow).remove();
	   	}
