...
// Falls Netzwerke mehrere URLs haben, dürfen sie mehrfach vorkommen. Pflege nur hier nötig. Das Netzwerk muss kein unterstütztes sein.
  ...
  'https://www.zanox-affiliate.de/ppc/',
  'http://partners.webmasterplan.com/click',
  'https://partners.webmasterplan.com/click',
  ...
  'https://www.awin1.com/',
    ...
    add_filter( 'plugin_action_links_' . plugin_basename(__FILE__), array(&$this,'wp2a_action_links') );  
...
// Zuerst prüfen, ob der Link in den Aff-Programmen vorhanden ist
  ...
  $linkdata = $wpdb->get_results($q, ARRAY_A);
    ...
    if ($this->options['testing'] == true){
      if (is_ssl()){
      $link = "https://ssl.webpack.de/wp2affiliate.com/redir-testing/redir.php?url=".$url;
      } else {
      $link = "http://www.wp2affiliate.com/redir-testing/redir.php?url=".$url;
      }
    } else {
      if (is_ssl()){
      $link = "https://ssl.webpack.de/wp2affiliate.com/redir/redir.php?url=".$url;
      } else {
 	...
 	function page_options(){
        ...
        // ### Holger: Neue Optionen mit Affiliate-Netzwerken // Für jedes Netzwerk wiederholen
      		...
      		$wpdb->query($q);
				...
				if ( $_POST['awin'] != $this->options['awin'] ){ // Wenn eine Netzwerk-ID eingetragen wurde, die vom vorhandenen Wert in den Options abweicht, speichern wir diese in die Options und in der DB bei allen Aff-Porgrammen, die das Netzwerk aktiv haben
					$this->options['awin'] = trim($_POST['awin']);
      		$q = "UPDATE {$wpdb->prefix}wp2ap_aff_links SET aff_code = '".trim($wpdb->escape($_POST['awin']))."' WHERE nw_aktiv = 'awin'";
      		$wpdb->query($q);
          } 
      		...
      		$wpdb->query($q);
				...
				if ( $_POST['eBayPartnerNet'] != $this->options['eBayPartnerNet'] ){ // Wenn eine Netzwerk-ID eingetragen wurde, die vom vorhandenen Wert in den Options abweicht, speichern wir diese in die Options und in der DB bei allen Aff-Porgrammen, die das Netzwerk aktiv haben
					$this->options['eBayPartnerNet'] = trim($_POST['eBayPartnerNet']);
      		$q = "UPDATE {$wpdb->prefix}wp2ap_aff_links SET aff_code = '".trim($wpdb->escape($_POST['eBayPartnerNet']))."' WHERE nw_aktiv = 'eBayPartnerNet'";
      		$wpdb->query($q);
          } 
...
<tr valign="top"> 
<th scope="row" style="width: 100px;"><a title="Zanox" target="_blank" href="http://zanox.com/"><?php _e('Zanox', 'wp-2-affiliate'); ?></a></th> 
...
<tr valign="top"> 
<th scope="row" style="width: 100px;"><a title="AWIN" target="_blank" href="https://www.awin.com/"><?php _e('Awin', 'wp-2-affiliate'); ?></a></th> 
<td width="15%" style="vertical-align: top;"><input type='text' name='awin' id='awin' value='<?php echo $this->options['awin']; ?>' size='15' />
</td>
<td style="vertical-align: top;">
  <p><?php _e('Your AWIN Publisher-ID', 'wp-2-affiliate'); ?></p>
  <p><?php _e('Example:', 'wp-2-affiliate'); ?> <code>612345</code></p>
  <p><?php _e('Source:', 'wp-2-affiliate'); ?> http://www.awin1.com/cread.php?awinmid=9134&awinaffid=<span class="wp2ap-redunderline">312345</span>&linkid=1032989&clickref=</p>
</td>
...
<tr valign="top"> 
<th scope="row" style="width: 100px;"><a title="eBay Partner Network" target="_blank" href="https://www.ebaypartnernetwork.ebay.com/"><?php _e('eBayPartnerNet', 'wp-2-affiliate'); ?></a></th> 
<td style="vertical-align: top;"><input type='text' name='eBayPartnerNet' id='eBayPartnerNet' value='<?php echo $this->options['eBayPartnerNet']; ?>' size='15' />
</td>
<td style="vertical-align: top;">
  <p><?php _e('Your eBay Partner Network Link-Code', 'wp-2-affiliate'); ?></p>
  <p><?php _e('Example:', 'wp-2-affiliate'); ?> <code>1/707-53477-19255-0/1?ff3=4&pub=5574871234&toolid=10001&campid=533641234&customid=</code></p>
  <p><?php _e('Source:', 'wp-2-affiliate'); ?> http://rover.ebay.com/rover/<span class="wp2ap-redunderline">1/707-53477-19255-0/1?ff3=4&pub=5574871234&toolid=10001&campid=533641234&customid=</span>&mpre=http%3A%2F%2Fwww.ebay.de
  <p><?php _e('Must be one time generated <a title="eBayPartnerNet Link-Generator" target="_blank" href="https://publisher.ebaypartnernetwork.ebay.com/PublisherToolsLinkGenPage">here</a> (Custom URL)!', 'wp-2-affiliate'); ?></p>
</td>
...
// ########## Holger: Start Funktion ajax_update_afflink
   ...
   */
    ...
    // Das preg_replace macht Probleme mit PHP > 5.5 (ab PHP 7 Fehler). Mit html_entity_decode erreichen wir das gleiche.
	    // ersetzt Zahlen
	    /*
   ...
   */
	...
	/**
	 * Einstellungslink hinzufuegen
	 * 
	 */
   
    function wp2a_action_links( $links ) {
       $links[] = '<a href="'. esc_url( get_admin_url(null, 'admin.php?page=wp2a_settings') ) .'">Settings</a>';
       return $links;
    }
